...
def main():
    ...
    def chooseDifficulty():
        difficulty = input("Select a difficulty level (1-5):")
        try:
    ...
    def chooseInitial():
        ...
        velocity = input("Choose initial velocity or enter to accept random assignment: ") or defaultVelocity
        try:
    ...
    def play(altitude, velocity, fuel, threshold):
        if altitude > 0:
            ...
            burn = input("How many pounds of fuel do you want to burn? ")
            if burn.isdigit():
                burn = int(burn)
